...
class ManageAssetsPage21 extends StatefulWidget {
  const ManageAssetsPage21({super.key});

  @override
  State<ManageAssetsPage21> createState() => _ManageAssetsPage21State();
}

class _ManageAssetsPage21State extends State<ManageAssetsPage21> {
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          GestureDetector(
                            onTap: () async {
                              final selected = await showStatusPickerDialog(
                                context,
                                localStatus,
                              );
                              if (selected != null) {
                                  ...
                                  Row(
                                    children: [
                                      Text(
                                        ...
                                        style: TextStyle(
                                          fontSize: 12,
                                          color: localStatus == 'Available'
                                              ? Colors.green
                                              : localStatus == 'Borrowed'
                                              ? Colors.orange
                                ...
                                child: ElevatedButton(
                                  onPressed: () {
                                    ...
                                    ScaffoldMessenger.of(
                                      ...
                                      SnackBar(
                                        content: Text(
                                          'Status of ${item['name']} set to $localStatus',
                                        ),
                    ...
                    children: [
                      GestureDetector(
                        onTap: () {
                          Navigator.of(
                            context,
                          ).pop('assets/images/notebook.png');
                        },
                        child: Container(
                          width: double.infinity,
                          padding: const EdgeInsets.symmetric(vertical: 10),
                      ...
                      GestureDetector(
                        onTap: () {
                          Navigator.of(
                            context,
                          ).pop('assets/images/Board_games.png');
                        },
                        child: Container(
                          width: double.infinity,
                          padding: const EdgeInsets.symmetric(vertical: 10),
        ...
        Expanded(
          child: ListView.builder(
            padding: const EdgeInsets.symmetric(
              horizontal: 16,
              vertical: 8,
            ), // เพิ่ม padding ด้านข้างและด้านบน/ล่าง
            itemCount: filtered.length,
            itemBuilder: (context, idx) {
              final item = filtered[idx];
              Color statusColor = item['status'] == 'Available'
                  ? Colors.green
              ...
              children: [
                Expanded(
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      hintText:
                          'Search by ID, Name, Borrower, Borrow Date, Return Date',
                      filled: true,
